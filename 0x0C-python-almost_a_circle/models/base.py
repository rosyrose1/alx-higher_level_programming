#!/usr/bin/python3
"""Gives a base class for all other classes within this module
"""
import json
import turtle
...
class Base():
    """Base class for all other classes witin this  module
    """
    HEADERS = ('id',)
    ...
    def draw(list_rectangles, list_squares):
        """illustrate  rectangles and squares in a new window
        """
        shapes = []
        if list_rectangles:
    ...
    def load_from_file_csv(cls):
        """Store a CSV representation of list_objs to <class_name>.json
        """
        try:
    ...
    def save_to_file(cls, list_objs):
        """Store a JSON representation of list_objs to <class-name>.json
        """
    ...
    def update(self, *args, **kwargs):
        """Revise the attributes of a base object
        """
        if args:
